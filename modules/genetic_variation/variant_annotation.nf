...
process VARIANT_ANNOTATION {
    ...
    output:
    path "${task.ext.outdir}/*[Tt]able*.box", emit: annotation_table   // Variant_Annotation_Table (inferred name)
    path "${task.ext.outdir}/*[Rr]eport*.box", emit: report            // Variant_Annotation_Report
